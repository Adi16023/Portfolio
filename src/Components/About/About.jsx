    ...
    <>
      <div className="about center">
        <h1 data-aos="fade-right" className="mobileHead">
          Hello, I am <span className="about__name">Adithya Challa</span>
        </h1>
        <Type />
        ...
        <div className="about__contact center">
          ...
          <a
            href="https://twitter.com/AdithyaChalla3"
            aria-label="twitter"
            className="link link--icon"
            target="_blank"
            rel="noreferrer"
        ...
        <button
          ...
          onClick={() => {
            window.open(
              "https://drive.google.com/file/d/1IV-If02F1aoxH6Qpo93m2J5Jzudt_BgP/view?usp=sharing"
            );
          }}
        >
          Resume
